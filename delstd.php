...
<script>
function del() {
			form1.action = "delstdpass.php?STDNAME=<?php echo $a ?>";
			form1.submit();
	}
function cancel() {
...
<br /><br />
    ...
    <label for="stdname" style="font-size:36px;margin-left:550px;"> DELETE STATION</label>
 ...
 <div class="jumbotron text-center">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control"  style="font-size:18px" name="stdcode">
  </div>
...
<center><table   border="0" align="center"   >
 ...
 <?php 
				$recordset = mysqli_query($con,"select * from add_station where STDNAME= '$a' ");
								
								while($record = mysqli_fetch_array($recordset))
								{
								echo"<script>
								form1.Nam.value ='",$record["STDNAME"],"';
								form1.stdcode.value ='",$record["STDCODE"],"';
