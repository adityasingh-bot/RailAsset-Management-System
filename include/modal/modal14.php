...
<body>
 ...
 <div class="modal fade" id="modal14" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" style="color:#ed1d24">ASSET DELETED!!!!!!</h4>
        </div>
        <div class="modal-body">
        <span class="glyphicon glyphicon-warning-sign" style="color:#ed1d24;font-size:60px;margin-left:240px" ></span>
          <h4 style="color:#ed1d24;margin-left:60px">ASSET DELETED SUCCESSFULLY!!!!!!!!!!!!</h4>
